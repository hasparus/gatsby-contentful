  ...
  allContentfulAsset {
    edges {
      ...
      <p>
        ...
        <code>height</code>
        {' '}
argument to the GraphQL argument to crop the image
        to a certain size.
      </p>
      <p>
...
you
        ...
        {' '}
        <code>maxWidth</code>
, the max width the container of the images
        reaches.
      </p>
  ...
  allContentfulAsset {
    edges {
      ...
      <p>
        ...
        that may be better than JPEG or PNG. The
        {' '}
        <code>srcWebp</code>
        {' '}
and
        {' '}
        <code>srcSetWebp</code>
        {' '}
